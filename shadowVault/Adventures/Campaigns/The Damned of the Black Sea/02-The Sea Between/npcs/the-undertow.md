...
- **Motivation:** The party's souls, **because** they drowned and drowned souls are owed to it — the ferryman is a thief and the debt must balance. The motive stands with or without this party; it has collected every wreck since the sea began.
- **Secrets:** It cannot lie — it has never needed to. It keeps every bargain *to the letter*, takes only what it is owed, and stops the instant the sum balances. Its claim — *"You drowned"* — is corroborated by nothing aboard and never may be (the ambiguity rule, [[00-overview|overview]]). **It keeps ledgers:** it never forgets souls that escaped it; any time a PC nearly drowns in later adventures, something in the water recognizes them (campaign thread).
...
It answers questions honestly, and every honest answer walks toward the bargain: *"I am owed one for each of you. Any souls will balance it. The ones below decks — no one will miss what no one remembers boarding."*
