...
- **Notable features:**
	- **The helm & the lantern** — [[the-old-sailor|the old man's]] post. A lantern that burns without oil, the only warm color in the world; at its heart the flame pulses with the same slow bluish beat as the temple's veined walls and the Shard. Boarders will not step into its circle — and the circle dims as he weakens (Night 0: most of the deck; Night 6: a stride across).
	...
	- **The crow's nest** — from the masthead, and only from there, sharp eyes glimpse the *other* sea: gulls, sunlight, a coastline, sails of the living world. Proof the destination is real; agony that it's so far ([[03-the-fog-banks|Act 3: The Crow's Nest]]).
...
| 4 | Sail patched where no one patched it, with cloth from nowhere | Five doors; two passengers now share what was three rooms |
